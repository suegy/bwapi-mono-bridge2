...
public static bool operator !=(Game obj1, Game obj2)
{
  ...
  public virtual SWIGTYPE_p_Region getRegion(int regionID) {
    IntPtr cPtr = bwapiPINVOKE.Game_getRegion(swigCPtr, regionID);
  ...
  public virtual SWIGTYPE_p_BWAPI__Region getRegionAt(int x, int y) {
    IntPtr cPtr = bwapiPINVOKE.Game_getRegionAt__SWIG_0(swigCPtr, x, y);
  ...
  public virtual SWIGTYPE_p_BWAPI__Region getRegionAt(Position position) {
    IntPtr cPtr = bwapiPINVOKE.Game_getRegionAt__SWIG_1(swigCPtr, Position.getCPtr(position));
    SWIGTYPE_p_BWAPI__Region ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_BWAPI__Region(cPtr, false);
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
